...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/song.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
	https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/5.4.py  
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{3.31}y(n - 1) + \brak{4.17}y(n - 2) \nonumber \\
	&- \brak{2.357}y(n - 3) + \brak{0.503}y(n - 4) \nonumber \\
	&= \brak{2.1\times 10^{-4}}x(n) + \brak{8.52 \times 10^{-4}}x(n - 1) \nonumber \\
	&+ \brak{1.27 \times 10^{-3}}x(n - 2) + \brak{8.52 \times 10^{-4}}x(n - 3) \nonumber \\
	&+ \brak{2.13 \times 10^{-4}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Prabhatkukunuri/Audio_Filtering/blob/main/EE1205/Audio_Filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
